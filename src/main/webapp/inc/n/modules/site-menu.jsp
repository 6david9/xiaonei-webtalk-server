...
<div class="site-menu-nav-box box">
	<article id="site-menu-nav" class="site-menu-nav">
		<section>
			...
			<div class="nav-item">
				<div class="item-title"><span class="item-main"><a href="http://blog.renren.com/blog/0/friendsNews?from=homeleft" ui-async="async"><img class="icon" src="${applicationScope.urlStatic}/n/res/icons/blog.png" /> 日志</a></span>
					<span class="item-operation"><a href="http://blog.renren.com/NewEntry.do" accesskey="p">发表</a></span>
				</div>
				<ul>
					<li><a href="http://blog.renren.com/blog/0?from=homeleft" ui-async="async">我的日志</a></li>
					<li><a href="http://blog.renren.com/blog/0/drafts?from=homeleft" ui-async="async">草稿箱</a></li>
					<li><a href="http://blog.renren.com/blog/0/myRelatives?from=homeleft" ui-async="async">与我相关的日志</a></li>
				</ul>
			</div>
			<div class="nav-item">
				<div class="item-title"><span class="item-main"><a href="http://photo.renren.com/photo/${visiter.id}/album/friends?from=homeleft" ui-async="async"><img class="icon" src="${applicationScope.urlStatic}/n/res/icons/photo.png" /> 相册</a></span>
					<span class="item-operation"><a class="flashUploader" href="http://upload.renren.com/index.do" accesskey="u">上传</a></span>
				</div>
				<ul>
					<li><a href="http://photo.renren.com/photo/${visiter.id}?from=homeleft" ui-async="async">我的相册</a></li>
					<li><a href="http://photo.renren.com/photo/${visiter.id}/tag?from=homeleft" ui-async="async">圈有我的照片</a></li>
					<li><a href="http://event.renren.com/?from=homeleft" ui-async="async">线上活动</a></li>
				</ul>
			</div>
            <div class="nav-item">
				<div class="item-title"><span class="item-main"><a href="http://music.renren.com/?from=homeleft" ui-async="async"><img class="icon" src="${applicationScope.urlStatic}/n/res/icons/music.png" /> 音乐</a></span>
					<span class="item-operation"><a href="javascript:openMusicBox();" accesskey="m">听歌</a></span>
				</div>
				<ul>
					<li><a href="http://music.renren.com/fm?from=homeleft" target="_blank">人人电台</a></li>
					<li><a href="http://music.renren.com/personal?from=homeLeft" ui-async="async">我的音乐</a></li>
				</ul>
			</div>
			<div class="nav-item">
				<div class="item-title"><span class="item-main"><a href="http://share.renren.com/share/hot?from=homeleft" ui-async="async"><img class="icon" src="${applicationScope.urlStatic}/n/res/icons/share.png" /> 分享</a></span></div>
				<ul>
					<li><a href="http://share.renren.com/share/friend?from=homeleft" ui-async="async">好友的分享</a></li>
					<li><a href="http://share.renren.com/share/${visiter.id}?from=homeleft" ui-async="async">我的分享</a></li>
					<li><a href="http://share.renren.com/share/collection?from=homeleft" ui-async="async">我的收藏</a></li>
				</ul>
			</div>
			
			<c:if test="${requestScope.show_topic==1}">
				<c:choose>
					<c:when test="${visiter.id%10==7}">
						<div class="nav-item">
							<div class="item-title"><span class="item-main"><a href="http://zhan.renren.com/home?from=homeTab&id=${visiter.id}" target="_blank"><img class="icon" src="${applicationScope.urlStatic}/imgpro/icons/zhan.png" /> 小站 <img src="http://a.xnimg.cn/imgpro/icons/new.png" class="new" /></a></span></div>
						</div>
					</c:when>
					<c:otherwise>
						<div class="nav-item">
							<div class="item-title"><span class="item-main"><a href="http://topic.renren.com/topic/wall?from=homeleft" ui-async="async"><img class="icon" src="${applicationScope.urlStatic}/imgpro/icons/zhan.png" /> 小站 <img src="http://a.xnimg.cn/imgpro/icons/new.png" class="new" /></a></span></div>
							<ul>
								<li><a href="http://topic.renren.com/topic/follow?from=homeleft" ui-async="async">我关注的小站</a></li>
							<c:forEach var="item" items="${requestScope.homeLeftSites}">
								<li><a href="http://zhan.renren.com/zhan/${item.id}?from=homeleft" target="_blank">${fn:substring(item.name, 0, 8)}${fn:length(item.name) > 8 ? "..." : ""}</a></li>
							</c:forEach>
							<c:if test="${fn:length(requestScope.homeLeftSites)<3}">
								<li class="create-zhan">
									<a href="http://zhan.renren.com/zhan/create?ref=renren_home" target="_blank">创建小站</a>
								</li>
							</c:if>
							</ul>
						</div>
			...
			<div class="nav-item">
				<div class="item-title"><span class="item-main"><a href="http://xiaozu.renren.com/xiaozu/index?from=homeleft" ui-async="async"><img class="icon" src="${applicationScope.urlStatic}/n/apps/group/res/xz_ico.png" /> 小组</a></span></div>
				<ul>
	...
	<article class="site-menu-apps">
        ...
        <section>
			...
			<c:if test="${!visiter.userStateInfo.guideDone && (visiter.stage==20||visiter.stage==30)}">
				<div class="apps-item">
					<div class="item-title">
						<span class="item-main">
							<a href="http://apps.renren.com/boyaa_texas/index.php?origin=103">
								<img width="16" height="16" class="icon" src="http://app.xnimg.cn/application/20090109/18/05/L559680023291HUA.gif" /> 德克萨斯扑克
							</a>
						</span>
					</div>
				</div>
					...
					<div class="item-title">
						<span class="item-main">
							<a href="${item.sideNavUrl}${sp}origin=50031">
								<img width="16" height="16" src="${item.appIcon}" class="icon" /> ${item.appName}
							</a>
						</span>
					</div>
				</div>
