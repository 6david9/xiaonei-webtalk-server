			...
			<div class="tabview tabview-align-right">
				...
				<div class="tabview-options" style="padding-top:6px;">
					<a class="news-feed-setting" href="${applicationScope.urlWww}/feedprefs.do">
						<img src="http://a.xnimg.cn/imgpro/v6/feed_setting.png" alt="新鲜事设置" title="新鲜事设置" style="display:block;" />
					</a>
				</div>
				<div class="tabview-tabs">
					<a href="#nogo" id="feedTabAttention" data-id="attention" onclick="return false;" class="a-tab">特别关注</a>
					<a href="#nogo" id="feedTabFeed" data-id="old" onclick="return false;" class="a-tab selected">热点内容</a>
				</div>
			</div>
